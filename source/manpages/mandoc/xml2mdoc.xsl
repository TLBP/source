...
<xsl:value-of select="concat('&#10;.Dd &#34;', d:info/t:pageinfo/t:date, '&#34;')"/>
<xsl:value-of select="concat('&#10;.Dt ', translate(normalize-space(d:info/t:pageinfo/t:name/text()), &allcases;, &uppercases;), ' ', d:info/t:pageinfo/t:volnum, ' &#34;', d:info/t:pageinfo/t:section, '&#34;')"/>
<xsl:value-of select="concat('&#10;.Os &#34;',d:info/t:pageinfo/t:source, '&#34;')"/>
  <xsl:variable name="p">
  ...
  <xsl:value-of select="concat('&#10;', normalize-space($p))"/>
<xsl:text>
.\" disable hyphenation (please, mandoc on Linux)
.nh
