...
<xsl:template name="article.titlepage.recto">
  ...
  <xsl:choose>
    ...
    <xsl:when test="articleinfo/lineage">
      <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/lineage"/>
    </xsl:when>
  </xsl:choose>
...
<xsl:template match="subtitle|lineage" mode="article.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="article.titlepage.recto.style">
<xsl:apply-templates select="." mode="article.titlepage.recto.mode"/>
</div>
</xsl:template>
...
<xsl:template match="cover|legalnotice" mode="article.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="article.titlepage.recto.style">
<xsl:apply-templates select="." mode="article.titlepage.recto.mode"/>
</div>
</xsl:template>
...
<xsl:template name="book.titlepage.recto">
  ...
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="bookinfo/cover"/></xsl:template>
...
<xsl:template match="cover|legalnotice" mode="book.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="book.titlepage.recto.style">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</div>
</xsl:template>
...
<xsl:call-template name="component.title">
<xsl:with-param name="node" select="ancestor-or-self::dictionary[1]"/>
</xsl:call-template></div>
  <xsl:choose>
    <xsl:when test="dictionaryinfo/subtitle">
      <xsl:apply-templates mode="dictionary.titlepage.recto.auto.mode" select="dictionaryinfo/subtitle"/>
    </xsl:when>
    <xsl:when test="docinfo/subtitle">
      <xsl:apply-templates mode="dictionary.titlepage.recto.auto.mode" select="docinfo/subtitle"/>
    </xsl:when>
    <xsl:when test="subtitle">
      <xsl:apply-templates mode="dictionary.titlepage.recto.auto.mode" select="subtitle"/>
    </xsl:when>
  </xsl:choose>
