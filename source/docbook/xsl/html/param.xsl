...
<!-- ********************************************************************
     $Id: param.xsl,v 1.4 2003/05/12 20:59:01 nilgun Exp $
     ********************************************************************
...
<xsl:param name="default.encoding" select="'ISO-8859-9'"/>
...
<xsl:param name="olink.outline.ext" select="''"/>
...
<xsl:param name="book.autolabel" select="1"/>
...
<xsl:param name="nochunk.article.children" select="'0'"/>
<xsl:param name="generate.article.toc" select="1"/>
