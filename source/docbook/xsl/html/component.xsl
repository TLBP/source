...
<!-- ********************************************************************
     $Id: component.xsl,v 1.6 2003/07/18 23:45:24 nilgun Exp $
     ********************************************************************
...
<xsl:template match="chapter">
  <div class="{name(.)}">
    ...
    <xsl:if test="$generate.chapter.toc != '0' or @role='autotoc'">
      <xsl:call-template name="component.toc"/>
    </xsl:if>
...
<xsl:template match="appendix">
  ...
  <xsl:text> </xsl:text>
    ...
    <xsl:if test="$generate.appendix.toc != '0' or @role='autotoc'">
      <xsl:call-template name="component.toc"/>
    </xsl:if>
    <dl><dd><xsl:apply-templates/>
    <xsl:call-template name="process.footnotes"/>
...
<xsl:template match="article">
  <div class="{name(.)}">
    ...
    <xsl:if test="(article-w3cinfo)">
      <xsl:apply-templates mode="w3crec.titlepage.mode"/>
    </xsl:if>
