...
<!ENTITY orig "http://www.w3.org/TR/2004/REC-xml-infoset-20040204">
<!ENTITY rec "xml-infoset">
]>
...
<xsl:text>
p.xml-def,
p.xml-syntax { margin-left: 2.5em; }
span.xml-def,
span.xml-syntax { color: #551122; font-weight: bold; }
</xsl:text>
</xsl:variable>
